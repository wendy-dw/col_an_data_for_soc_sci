...
We will plan to follow the following steps:
...
3. A statistical analysis: It is yet unclear which statistical analysis will fit best to answer our main research questions pertaining to the difference in sentiment/opinion on the Israeli-Palestinian conflict, depending on the language of the documents.


## Proof of concept

In this section, we briefly test the web scraping and crawling from wikipedia as a proof-of-concept. We refer to the [github repository](https://github.com/raiisac/col_an_data_for_soc_sci.git) to view the source code.
