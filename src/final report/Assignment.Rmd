...
! [Division of Palestinian and Israeli territory over the years (source: https://yalibnan.com/2014/06/27/eu-warns-business-israeli-settlements/)](vanishing-palestine.jpg)
...
# Since an authentication key is needed to perform the translation, we save the translated keywords to github and load them from there.
             ...
             israel = sapply(X = seq_len(nrow(content)),
                             FUN = function(x){
                               key <- keywords[1,
                                               as.character(
                                                 unlist(
                                                   content[x, "language"]))]#get the term in the appropriate language
                               return(str_count(
